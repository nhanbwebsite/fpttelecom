<div>
    <header>
       <img src="{{ asset('image/fpt-logo.svg') }}" alt=""> <h1>Chọn gói cước Internet FPT phù hợp với bạn</h1>
    </header>
        ...
        <div class="plan">
            ...
            <div class="plan-content">
                ...
                <div class="btn-submit-wifi">
                    <a href="{{route('deal.fpttelecom.order',$item->slug)}}" type="button" class="btn btn-primary"
                        class="btn">Đăng ký
                        ngay</a>
                </div>
            </div>
